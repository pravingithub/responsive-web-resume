...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Zachary D. Tribbett | Resume</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Curriculum Vitae for Zachary D. Tribbett">
    <meta name="author" content="Zachary Tribbett">
	...
	<script type="text/javascript">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-21234305-4']);
...
<body class="preview" data-spy="scroll" data-target=".subnav" data-offset="80">
    ...
    <div class="row">
	<div class="span12">		
      <h1 style="padding: 10px 0px; text-align: center; font-size: 60px">Zachary D. Tribbett</h1>
	  <h3 style="text-align: center; text-style: italic">Unconventionally Adventurous</h3>

	<span class="" style="text-align: center;"> 
		<address>
		<a href="http://www.zacharytribbett.com" target="_blank">www.zacharytribbett.com</a><br />
		<a href="mailto:tribbett@mit.edu">tribbett@mit.edu</a><br />
		<a>+1.857.244.1356</a>
		</address>
	</span>
		</div>
...
<section id="about">
 ...
 <h2>About</h2>
      ...
      <div class="span12">Zachary D. Tribbett is a senior at the Massachusetts Institute of Technology majoring in Computer Science and Psychology. He also does contract web development and tutoring during the school year. Zachary has a strong passion for education and developing innovative and entrepreneurial skills in academics. After his time as a teaching fellow, Zachary co-founded Start Labs, a nonprofit whose goal is to develop the next generation of technical innovators and entrepreneurs. Beyond work, Zachary is an avid backpacker and traveler, writer, poet, basketball-er, and Captain Kirk enthusiast. Zachary plans to work in A.I., data analysis, and machine learning, and is currently seeking full-time employment opportunities beginning after graduation. 
    </div> 
...
<?php
position("Massachusetts Institute of Technology","Cambridge, MA","Bachelor of Science in Computer Science","Expected 6/13",'
<ul>
<li><span style="font-weight: bold">Relevant Coursework:</span> Computational Cognitive Science, Natural Language Processing, Systems Design &amp Optimization, User Interfaces, Advanced Algorithms &amp Data Structures, and Game Theory/Pokebots.</li>
<li><span style="font-weight: bold">Senior Project:</span> TBD</span></li>
<li><span style="font-weight: bold">Clubs &amp Activities:</span> Undergraduate Senator, Living Group Chair, Shakespeare Ensemble, Dramashop, Startup Club/Start Labs, DevShop, Student Information Processing Board, Startup@CSAIL, Undergraduate Research, MIT TechFair.</li>
</ul>',"");
?>
...
<?php
iprogram('Python','90');
iprogram('Flask, Django','85');
iprogram('Java','90');
iprogram('Ruby &amp Rails','80');
iprogram('PHP','50');
iprogram('CSS, Stylus, Less','75');
...
<div class="span4">
	<div class="well">
		<h4>Zachary on the Web</h4>
		<hr />
		<ul>
		<?php
			project('Personal Website','http://www.zacharytribbett.com','');
			project('Twitter','http://www.twitter.com/tribbettz','');
			project('Github','http://github.com/tribbettz', '');
			project('Resume (PDF)','http://www.zacharytribbett.com/resume.pdf','');
		?>
		</ul>
		<br />
	</div>
	...
	<hr />
      <p style="text-align: center">&copy; <a href="http://www.zacharytribbett.com" target="_BLANK">Zachary D. Tribbet</a> 2012</p>
      </footer>      
